      ...
      {groupedTasks.map((group) => {
        ...
        return (
          <List.Section
            ...
            subtitle={`${pluralize(group.tasks.length, 'task')}, total ${pluralize(group.totalManhours, 'hour')}`}
          >
                ...
                <List.Item
                  ...
                  actions={
                    <ActionPanel>
                      ...
                      <ActionPanel.Section>
                        <ToggleShowDetailsAction onAction={handleToggleShowDetails} isShowingDetail={isShowingDetail} />
                        <SettingAction />
                      </ActionPanel.Section>
                    </ActionPanel>
                  }
